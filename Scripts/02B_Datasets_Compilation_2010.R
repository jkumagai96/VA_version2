...
# Modified code so that only 2010 and more recent studies are used 
# Values Assessment 
...
# Export 
#dir.create("Outputs/Corpus_2010")
write.csv(df, "Outputs/Corpus_2010/harmonized_data.csv", row.names = F)
...
# Export 
#dir.create("Outputs/Uptake_Q6_2010")
write.csv(df, "Outputs/Uptake_Q6_2010/harmonized_data_Q6.csv", row.names = F)
...
# Export 
#dir.create("Outputs/Uptake_Q8_2010")
write.csv(df, "Outputs/Uptake_Q8_2010/harmonized_data_Q8.csv", row.names = F)
...
# Export 
#dir.create("Outputs/Uptake_Q13_2010")
write.csv(df, "Outputs/Uptake_Q13_2010/harmonized_data_13.csv", row.names = F)
...
# Export 
#dir.create("Outputs/Uptake_Q6_8_13_2010")
write.csv(df, "Outputs/Uptake_Q6_8_13_2010/harmonized_data_Q6_8_13.csv", row.names = F)
...
# Export 
#dir.create("Outputs/Uptake_Q2ESvaluation_2010")
write.csv(df, "Outputs/Uptake_Q2ESvaluation_2010/harmonized_data_Q2.csv", row.names = F)
...
# Export 
#dir.create("Outputs/Uptake_Q4_2010")
write.csv(df, "Outputs/Uptake_Q4_2010/harmonized_data_Q4.csv", row.names = F)
...
# Export 
#dir.create("Outputs/Uptake_Q8_13_2010")
write.csv(df, "Outputs/Uptake_Q8_13_2010/harmonized_data_Q8_13.csv", row.names = F)
