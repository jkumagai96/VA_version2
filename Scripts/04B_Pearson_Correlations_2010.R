...
uptakeQ2 <- read.csv("Outputs/Uptake_Q2ESvaluation_2010/harmonized_data_Q2.csv") %>% 
  select(ISO_Alpha_3, Names1, Names2)
...
#### Export ####
png("Outputs/Corpus_2010/pearson_filtered_plot.png", 
    units = "in", 
    width = 8, 
    height = 8, 
    pointsize=10,
...
png("Outputs/Uptake_Q2ESvaluation_2010/pearson_filtered_plot.png", 
    units = "in", 
    width = 8, 
    height = 8, 
    pointsize=10,
