...
ggsave(file = "Outputs/Figures/Density_of_studies_after_2010_log.svg", plot = plotA_log, width = 7, height = 5, dpi = 600)
...
ggsave(file = "Outputs/Figures/Density_of_studies_subregion.svg", plot = n1_subregion_poly_plot, width = 7, height = 5, dpi = 600)
```
```{r, include = F}
...
ggsave(file = "Outputs/Figures/Density_of_studies_pre1990.svg", plot = plot1990, width = 7, height = 5, dpi = 600)
```
...
ggsave(file = "Outputs/Figures/Density_of_studies_1990-2000.svg", plot = plot2000, width = 7, height = 5, dpi = 600)
```
...
ggsave(file = "Outputs/Figures/Density_of_studies_2000-2010.svg", plot = plot2010, width = 7, height = 5, dpi = 600)
```
...
ggsave(file = "Outputs/Figures/Density_of_studies_2010-2020.svg", plot = plot2020, width = 7, height = 5, dpi = 600)
