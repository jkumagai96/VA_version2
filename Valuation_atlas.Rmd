...
We will now present the results from the analysis through a series of maps showing both the raw country or territory results and summarized by IPBES regions and subregions. No data is always displayed in grey. The darker green values represent a higher density of studies, while the darker blue values represent a higher density of institutions.
...
```{r names1/names2, fig.height = 6, fig.width = 8, fig.align = 'center', fig.cap = "Density of studies vs density of institutions", message = F, warning = F}
harmonized_data %>% 
...
While most significant relationships are positive, there are two negative relationships present. Biodiversity intactness index is negatively correlated with both the density of studies and institutions, and protected area management effectiveness is slightly negative correlated with the density of institutions.
...
```{r, fig.align='center', fig.width=8, fig.height=8, dpi=300, cache=TRUE, fig.cap = "Pearson correlations of geographic valuation studies and indicators"}
...
corrplot(as.matrix(data_r), is.corr = FALSE, cl.ratio = .6, tl.col="black",tl.srt = 45,
         p.mat = as.matrix(data_p), sig.level = 0.01, insig = "blank") 
```
...
```{r, fig.align='center', fig.width=9, fig.height=8, dpi=300, cache=TRUE, fig.cap = "Pearson correlations of geographic valuation studies and indicators"}
 #### Correlation Analysis ####
# calculate correlations 
res1 <- rcorr(as.matrix(df), type = "pearson") # Only linear relationships 
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and the human development index"}
Plot_function(all_data, all_data$hdi_2018, "Human Development Index (2018)")
```
  
**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and the human development index"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and learning outcomes"}
Plot_function(all_data, all_data$Learning_outcomes_2015, "Learning Oucomes (2015)")
```
  
**Log relationship graphs:**
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and learning outcomes"}
Plot_function_log(all_data, all_data$Learning_outcomes_2015, "Learning Oucomes (2015)")
```
  
### GDP {.unnumbered}

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and GDP"}
Plot_function(all_data, all_data$GDP_2019, "GDP (2019)")
```
  
**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and GDP"}
Plot_function_log(all_data, all_data$GDP_2019, "GDP (2019)")
```

### Corruption Perception Index {.unnumbered}

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and the corruption perception index"}
Plot_function(all_data, all_data$CPI_2020, "Corruption Perception Index (2020)")
```
  
**Log relationship graphs:**
  
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and the corruption perception index"}
Plot_function_log(all_data, all_data$CPI_2020, "Corruption Perception Index (2020)")
```
  
### Population {.unnumbered}

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and population"}
Plot_function(all_data, all_data$Pop_2018, "Population in Millions (2018)")
```
  
**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and population"}
Plot_function_log(all_data, all_data$Pop_2018, "Population in Millions (2018)")
```
  
### GDP per capita {.unnumbered}

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and GDP per capita"}
d <- all_data %>% 
  mutate(GDP_per_capita = GDP_2019/Pop_2018) 
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and GDP per capita"}
Plot_function_log_topright(d, d$GDP_per_capita, "GDP per Capita")
```
  
### Forest Area Under FSC Certification {.unnumbered}

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and forest area under FSC certification"}
Plot_function(all_data, all_data$`Forest Area under FSC certification`, "Forest area under FSC certification")
```
   
**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and forest area under FSC certification"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and the biodiversity habitat index"}
Plot_function_topright(all_data, all_data$`Biodiversity Habitat Index`, "Biodiversity Habitat Index")
```
   
**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and the biodiversity habitat index"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and the biodiversity intactness index"}
Plot_function_topright(all_data, all_data$`Biodiversity Intactness Index`, "Biodiversity Intactness Index")
```
   
**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and the biodiversity intactness index"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and the biocapacity per capita"}
Plot_function_topright(all_data, all_data$`Biocapacity per capita`, "Biocapacity per Capita")
```
   
**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and the biocapacity per capita"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and the ecological footprint per capita"}
Plot_function(all_data, all_data$`Ecological Footprint per capita`, "Ecological Footprint per Capita")
```
  
**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and the ecological footprint per capita"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and forest area"}
Plot_function(all_data, all_data$`Forest area`, "Forest Area")
```
  
**Log relationship graphs:**
  
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and forest area"}
Plot_function_log(all_data, all_data$`Forest area`, "Forest Area")
```
   
### Water Footprint {.unnumbered}

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and the water footprint"}
Plot_function(all_data, all_data$`Water Footprint`, "Water Footprint")
```
  
**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and the water footprint"}
Plot_function_log(all_data, all_data$`Water Footprint`, "Water Footprint")
```
  
### Inland Fishery Production {.unnumbered}

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and inland fishery production"}
Plot_function(all_data, all_data$`Inland Fishery Production`, "Inland Fishery Production")
```
   
**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and inland fishery production"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Relationships between density of valuation studies and associated institutions, and the region-based marine trophic index"}
Plot_function(all_data, all_data$`Marine Trophic Index (1950)`, "Marine Trophic Index in reference to 1950")
```
   
**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7,fig.cap = "Log relationships between density of valuation studies and associated insitutions, and the region-based marine trophic index"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and nitrogen fertization"}
Plot_function(all_data, all_data$`Nitrogen Fertilizers`, "Nitrogen Fertilizers")
```
  
**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between density of valuation studies and associated insitutions, and nitrogen fertization"}
Plot_function_log(all_data, all_data$`Nitrogen Fertilizers`, "Nitrogen Fertilizers")
```
   
### Percent Nitrogen Use Efficiency {.unnumbered}

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and nitrogen use efficiency"}
Plot_function(all_data, all_data$`Nitrogen Use Efficiency (%)`, "Nitrogen Use Efficiency (%)")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between density of valuation studies and associated insitutions, and nitrogen use efficiency"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and percentage of area covered by protected areas"}
Plot_function_topright(all_data, all_data$`Percentage protected`, "Percentage of Area Covered by PAs")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between density of valuation studies and associated insitutions, and percentage of area covered by protected areas"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and percentage of undernourished people"}
Plot_function_topright(all_data, all_data$`Percentage of undernourished people`, "Percentage of Undernourished People")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between density of valuation studies and associated insitutions, and percentage of undernourished people"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and local breeds at risk of extinction"}
Plot_function_topright(all_data, all_data$`Local Breeds at risk of extinction`, "Local Breeds At Risk of Extinction")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between density of valuation studies and associated insitutions, and local breeds at risk of extinction"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and PA of key biodiverisy area coverage"}
Plot_function_topright(all_data, all_data$`PA of Key Biodiversity Areas Coverage (%)`, "Percentage of KBA covered by PAs")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between valuation atlas and PA of key biodiverisy area coverage"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and protected area management effectiveness"}
Plot_function_topright(all_data, all_data$`Protected area management effectiveness`, "PA Assessed on Management Effectiveness (%)")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between valuation atlas and protected area management effectiveness"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and the protected area connectedness index"}
Plot_function(all_data, all_data$`Protected Area Connectedness Index`, "PA Connectedness Index")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between valuation atlas and the protected area connectedness index"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and the species habitat index"}
Plot_function(all_data, all_data$`Species Habitat Index`, "Species Habitat Index")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between valuation atlas and the species habitat index"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and the species protection index"}
Plot_function(all_data, all_data$`Species Protection Index (%)`, "Species Protection Index (%)")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between valuation atlas and the species protection index"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and the species status information index"}
Plot_function_topright(all_data, all_data$`Species Status Information Index`, "Species Status Information Index")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between valuation atlas and the species status information index"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and total wood removals"}
Plot_function(all_data, all_data$`Total Wood Removals`, "Total wood removals (roundwood, m3")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between valuation atlas and total wood removals"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and trends in forest extent"}
Plot_function_topright(all_data, all_data$`Trends in forest extent`, "Trends in forest extent")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between valuation atlas and trends in forest extent"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and nitrogen deposition trends"}
Plot_function(all_data, all_data$`Nitrogen Deposition Trends`, "Nitrogen Deposition Trends (kg N/ha/yr)")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between valuation atlas and nitrogen deposition trends"}
...
```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Relationships between density of valuation studies and associated institutions, and trends in pesticides use"}
Plot_function(all_data, all_data$`Trends in Pesticides Use`, "Trends in Pesticides Use")
```

**Log relationship graphs:**

```{r fig.align = 'center', message = F, warning=F, fig.height=7, fig.width=7, fig.cap = "Log relationships between valuation atlas and trends in pesticides use"}
