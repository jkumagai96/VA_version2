...
corrplot(as.matrix(data_r), is.corr = FALSE, cl.ratio = .6, cl.cex = .8, cl.align.text = "l",
...
# plot rectangular correlation plot
corrplot(as.matrix(data_r), is.corr = FALSE, cl.ratio = .6, cl.cex = .8, cl.align.text = "l", tl.col="black", tl.srt = 45, 
