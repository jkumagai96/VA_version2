...
# countries <- st_simplify(st_wrap_dateline(read_sf("Data/gadm36_levels_shp/gadm36_0.shp")), preserveTopology = F, dTolerance=1000) %>%     # st_simplify is new in hopes to reduce loading time of map
#   rename(ISO_Alpha_3 = GID_0)
